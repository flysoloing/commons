...
import com.flysoloing.commons.pagination.Pager;
...
public class PaginationUtils {
    ...
    /**
     * 根据分页条件类对象得到分页对象
     * @param pagination 分页条件类对象
     * @return 分页对象
     */
    public static Pager pagination(Pagination pagination) {
        return pagination(pagination.getTotalRecord(), pagination.getPageSize(), pagination.getCurrentIndex(), pagination.getIndexOffset());
    }
